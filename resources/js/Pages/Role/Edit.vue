...
const filteredPermissions = computed(() => {
    ...
    Object.keys(props.permissions).forEach(module => {
        const matches = props.permissions[module].filter(p =>
...
// Role admin dikunci: nama, status, dan permission tidak boleh diubah.
const isAdminRole = computed(() => props.role.name === 'admin');
...
function submit() {
    form.put(`/role/${props.role.id}`, {
        ...
        onError: () => {
            window.toast?.error('Gagal mengupdate role');
        },
    });
}
</script>
            ...
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <p class="text-muted small mb-0">Update informasi role dan permissions</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <small class="text-muted">
                                        {{ isAdminRole ? 'Role admin tidak boleh diubah namanya' : 'Slug unik (huruf kecil, tanpa spasi)' }}
                                    </small>
                                </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div v-if="isAdminRole" class="alert alert-warning d-flex align-items-start gap-2 mb-3">
                                <i class="bx bx-lock-alt fs-5 mt-1"></i>
                                <div class="small">
                                    <strong>Role admin dikunci.</strong> Permissions admin selalu lengkap dan tidak bisa diubah —
                                    ini supaya sistem tidak terkunci dari sisi superuser. Untuk membatasi akses,
                                    buat role baru (misal "staff" atau "operator") dan atur permission-nya di sana.
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap gap-2">
                                ...
                                <div class="d-flex gap-2 flex-wrap">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-success" @click="selectAll" :disabled="isAdminRole">
                                        <i class="bx bx-check-double me-1"></i>Pilih Semua
                                    </button>
                                    <button type="button" class="btn btn-sm btn-outline-secondary" @click="deselectAll" :disabled="isAdminRole">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled small mb-0">
                                ...
                                <li class="mb-2">
                                    ...
                                    {{ new Date(role.updated_at).toLocaleString('id-ID') }}
                                </li>
                            </ul>
                        </div>
                    </div>
