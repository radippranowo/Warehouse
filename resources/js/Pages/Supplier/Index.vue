...
const { loading } = usePartialReloadLoading('/supplier');
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="search-box">
                                <div class="position-relative">
                                    <input id="search_supplier" name="search" v-model="search" type="text" class="form-control"
                                        placeholder="Cari kode / nama / kontak..." style="padding-left: 36px; height: 38px;" aria-label="Cari supplier">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap table-hover">
                            ...
                            <TransitionGroup tag="tbody" :name="animateRows ? 'row-fade' : ''">
                                ...
                                <tr v-else v-for="(item, i) in displayItems.data" :key="item.id ?? item.kode_supplier"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <select id="per_page_supplier" name="per_page" v-model="perPage" @change="changePerPage(perPage)" class="form-select form-select-sm" style="width: 70px;" aria-label="Jumlah data per halaman">
